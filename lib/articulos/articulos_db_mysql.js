...
module.exports.getArticulos = function(callback) {
    ...
    var articulos = null;
    sql = "SELECT a.*, tiv.nombre AS tipoIVA FROM articulos AS a LEFT JOIN tipos_iva AS tiv ON tiv.tipoIva = a.tipoIva";
...
module.exports.getArticulosBuscar = function(nombre, callback) {
    var connection = getConnection();
    var articulos = null;
    var sql = "SELECT a.*, tiv.nombre AS tipoIVA FROM articulos AS a LEFT JOIN tipos_iva AS tiv ON tiv.tipoIva = a.tipoIva";
    if (nombre !== "*") {
        sql = "SELECT a.*, tiv.nombre AS tipoIVA FROM articulos AS a LEFT JOIN tipos_iva AS tiv ON tiv.tipoIva = a.tipoIva";
...
module.exports.getArticulo = function(id, callback) {
    var connection = getConnection();
    var articulos = null;
    sql = "SSELECT a.*, tiv.nombre AS tipoIVA FROM articulos AS a LEFT JOIN tipos_iva AS tiv ON tiv.tipoIva = a.tipoIva";
