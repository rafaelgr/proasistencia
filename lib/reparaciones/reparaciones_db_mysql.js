...
module.exports.getReparaciones = function(callback){
	...
	sql = "SELECT re.*, CONCAT(ar.nombre, '(',ar.codigoReparacion,')') as articulo, tc.nombre as tarifaCliNombre, tic.nombre as tipoIvaCliente,";
	sql += "  tp.nombre as tarifaProNombre, tip.nombre as tipoIvaProveedor"
...
module.exports.getReparacionServicio = function(id, callback){
	var connection = getConnection();
    var reparaciones = null;
    sql = "SELECT re.*, CONCAT(ar.nombre, '(',ar.codigoReparacion,')') as articulo, tc.nombre as tarifaCliNombre, tic.nombre as tipoIvaCliente,";
	sql += "  tp.nombre as tarifaProNombre, tip.nombre as tipoIvaProveedor"
