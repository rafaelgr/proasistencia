...
const pool = mysql.createPool({
    host: process.env.BASE_MYSQL_HOST, // Cambia esto según tu configuración
    user: process.env.BASE_MYSQL_USER,      // Cambia esto según tu configuración
    password: process.env.BASE_MYSQL_PASSWORD, // Cambia esto según tu configuración
    port: process.env.BASE_MYSQL_PORT,      // Cambia esto según tu configuración
    charset: process.env.BASE_MYSQL_CHARSET,
    database: process.env.BASE_MYSQL_DATABASE,  // Cambia esto según tu configuración
