...
router.get('/usuario/logado/departamento/:usuarioId', function (req, res) {
    prefacturasDb.getPrefacturasUsuario(req.params.usuarioId, function (err, prefacturas) {
        if (err) {
            return res.status(500).send(err.message);
        } else {
            res.json(prefacturas);
...
router.get('/usuario/logado/departamento/all/:usuarioId', function (req, res) {
    prefacturasDb.getPrefacturasAllUsuario(req.params.usuarioId, function (err, prefacturas) {
        if (err) {
            return res.status(500).send(err.message);
        } else {
            res.json(prefacturas);
