...
var obtenerImporteAlClienteDesdeCoste = function (coste, porcentajeBeneficio, porcentajeAgente, tipoClienteId) {
    ...
    if (tipoClienteId == 1){
        // es un mantenedor
        importeAlCliente = importeAlCliente - roundToTwo(ventaNeta + importeBeneficio);
    }
...
var obtenerImporteAlClienteDesdeCosteLineal = function (linea, porcentajeAgente, tipoClienteId) {
    ...
    if (porcentajeAgente) {
        ...
        importeAgenteLinea = roundToTwo(totalLinea - roundToTwo(linea.ventaNetaLinea));
        if (tipoClienteId == 1){
            // es un mantenedor
            totalLinea = totalLinea - roundToTwo(linea.ventaNetaLinea + linea.importeBeneficioLinea);
        }
    }
    var obj = {
