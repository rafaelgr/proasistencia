...
module.exports.postCrearReport = function (dFecha, hFecha, clienteId, empresaId, tipoIvaId, factu, orden, departamentoId, usuarioId, callback) {
    var connection = getConnection();
    var obj = 
        {
            libCli: ""
        }
    var sql = "SELECT  f.empresaId,  emp.nombre AS empresaNombre, f.prefacturaId, fecha,";
...
var fnActualizarTotales = function (id, callback) {
    ...
    sql += " (SELECT prefacturaId, SUM(coste) AS sc, porcentajeBeneficio AS pb, porcentajeAgente AS pa";
