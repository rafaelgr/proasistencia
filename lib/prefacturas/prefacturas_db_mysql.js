...
module.exports.getPrefacturas = function (callback) {
    ...
    sql = "SELECT *, CONCAT(COALESCE(ano,' '),'-',COALESCE(serie,' '),'-',COALESCE(numero,' ')) AS vNum FROM prefacturas";
...
module.exports.getPreEmisionFacturas = function (dFecha, hFecha, callback) {
    var connection = getConnection();
    var prefacturas = null;
...
module.exports.getPrefacturasContrato = function (id, callback) {
    var connection = getConnection();
    var prefacturas = null;
    sql = "SELECT *, CONCAT(COALESCE(ano,' '),'-',COALESCE(serie,' '),'-',COALESCE(numero,' ')) AS vNum FROM prefacturas WHERE contratoClienteMantenimientoId = ?";
