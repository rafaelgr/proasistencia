...
module.exports.getPreCorreoFacturas = function (dFecha, hFecha, empresaId, departamentoId, callback) {
    var connection = getConnection();
        var sql = "SELECT f.*, numeroFacturaProveedor AS vNum";
        ...
        sql += " WHERE f.fecha >= ? AND f.fecha <= ? AND sel = 1";
