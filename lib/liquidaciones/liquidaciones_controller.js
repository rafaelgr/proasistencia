...
//Obtiene un objeto JSON para el informe de liquidaciones por colaborador resumen
router.post('/colaborador/informe/resumen/crea/json/:dFecha/:hFecha/:comercialId/:tipoComercialId/:departamentoId/:usuario', function (req, res) {
    var dFecha = req.params.dFecha;
    var hFecha = req.params.hFecha;
    var departamentoId = req.params.departamentoId;
    var comercialId = req.params.comercialId;
