...
var procesaLiquidacionesObras = function(dFecha, hFecha, con, done) {
    ...
    con.query(sql, function (err, res) {
        ...
        sql = "SELECT l.contratoId, l.ascContratoId,";
        sql += " c.firmaActa,";
        sql += " SUM(c.importeCliente) AS importeObra,";
        ...
        sql += " SUM(c.importeCliente) - (SUM(l.pagadoPeriodo)+ SUM(l.pagadoAnterior)+ COALESCE(lo.abonado, 0)) AS pendienteAbono,";
        sql += " SUM(l.pendientePeriodo) AS pendientePeriodo,";
        sql += " SUM(l.pagadoPeriodo) AS pagadoPeriodo,";
        sql += " SUM(l.pendienteAnterior) AS pendienteAnterior,";
        sql += " SUM(l.pagadoAnterior) AS pagadoAnterior,";
        ...
        sql += " ) AS lo ON lo.ascContratoId = l.ascContratoId";
        sql += " WHERE c.tipoContratoId = 8 ";
        sql += " AND l.dFecha = ? AND l.hFecha = ?";
        sql += " GROUP BY l.contratoId ORDER BY l.ascContratoId ";
