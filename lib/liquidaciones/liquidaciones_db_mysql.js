    ...
    var obj = 
        {
            ...
            sql += " liq.IC,";
            sql += " liq.coste,";
            sql += " COALESCE(cnt.certificacionFinal - liq.PC, 0) AS certificacionNeta,";
            sql += " COALESCE((cnt.certificacionFinal - liq.PC) - liq.coste, 0) AS BI,";
            sql += " COALESCE((((cnt.certificacionFinal - liq.PC) - liq.coste)/liq.coste) * 100, 0) AS porBI,";
