...
var crearReportResumen = function(dFecha, hFecha, departamentoId, tipoComercialId, comercialId, usuario, callback) {
    ...
    var obj = 
        ...
        sql += " com.nombre AS nomComercial,";
        sql += " tpp.nombre AS tipoProyecto,";
        sql += " tpp.tipoProyectoId AS tipoContratoId,";
        sql += " cli.nombre AS nomCliente,";
        sql += " cnt.direccion,"
        sql += " cnt.referencia,";
        sql += " CONCAT(fac.serie, '-', fac.ano, '-', fac.numero) AS numfactu,";
        ...
        sql += " AND (liq.pendienteAnterior <> 0 OR liq.pagadoAnterior <> 0))";
        sql += "GROUP BY com.comercialId, cnt.tipoContratoId"
        sql += " ORDER BY com.comercialId)";
        ...
        sql += " "
        sql += " com.comercialId,"; 
        sql += " 7 AS tipoProyectoId AS tipoProyectoId,"
        sql += " REPARACIONES AS tipoProyecto,";
        sql += " com.nombre AS nomComercial,";
        sql += " cli.nombre AS nomCliente,";
        sql += " '' AS direccion,";
        sql += " '' AS referencia,";
        ...
        sql += " AND fac.departamentoId = 7 AND liq.pendienteAnterior <> 0)";
        sql += "GROUP BY com.comercialId, tipoProyectoId "
        sql += " ORDER BY com.comercialId)";
        sql += " ORDER BY comercialId";
    connection.query(sql, function (err, result) {
        closeConnectionCallback(connection, callback);
