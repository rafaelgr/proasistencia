...
var procesaLiquidacionesObras = function(dFecha, hFecha, con, done) {
    ...
    sql += " SUM(l.impCliente) + COALESCE(lo.facturado, 0)   AS facturado,";
    sql += " SUM(l.pagadoPeriodo) + COALESCE(lo.abonado, 0) AS abonado,";
    sql += " c.importeCliente - (SUM(l.pagadoPeriodo) + SUM(l.pagadoAnterior)) AS pendienteAbono,";
