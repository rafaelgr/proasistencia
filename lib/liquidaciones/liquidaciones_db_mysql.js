...
var crearReport = function(dFecha, hFecha, departamentoId, tipoComercialId, comercialId, usuario, callback) {
    ...
    var obj = 
        ...
        if(departamentoId !=7 && departamentoId > 0) {
            ...
            sql += " AND (fac.liquidadaAgente= 0 OR liq.pagadoAnterior <> 0))";
            ...
            sql += " AND fac.departamentoId = 7 AND (fac.liquidadaAgente = 0 OR liq.pagadoAnterior <> 0))";
            sql += " ORDER BY com.comercialId";
        }
        else {
            sql = "(SELECT";
            ...
            sql += " AND fac.departamentoId = 7 AND fac.liquidadaAgente = 0)";
            sql += " ORDER BY com.comercialId)";
...
var crearReportCorreo = function(dFecha, hFecha, departamentoId, tipoComercialId, comercialId, usuario, callback) {
    ...
    var obj = 
        ...
        if(departamentoId !=7 && departamentoId > 0) {
            ...
            sql += " AND fac.departamentoId = 7 AND (fac.liquidadaAgent = 0 OR liq.pagadoAnterior <> 0))";
        }
        else {
            sql = "SELECT";
            sql += " '" + moment(dFecha).format('DD/MM/YYYY') + "' as dFecha,";
