    ...
    con.beginTransaction(function (err) {
        ...
        */
        con.query(sql, function (err, res) {
            ...
            sql = "SELECT DISTINCT cli.nombre, clag.comercialId as histComercialId, DATE_FORMAT(clag.fechaCambio, '%y-%m-%d') AS fechaCambio,"; 
            sql += " f.facturaId, DATE_FORMAT(f.fecha, '%y-%m-%d') AS fecha, DATE_FORMAT( '" + dFecha + "', '%y-%m-%d') AS inicioPeriodo, DATE_FORMAT( '" + hFecha + "', '%y-%m-%d') AS finPeriodo, f.serie, f.ano, f.numero, f.totalAlCliente, f.coste, f.porcentajeAgente,";
...
var procesaLiquidacionesObras = function(dFecha, hFecha, con, done) {
    ...
    con.query(sql, function (err, res) {
        ...
        sql += " WHERE c.tipoContratoId = 8 AND c.contratoId = 3554";
