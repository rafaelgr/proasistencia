...
var liquidacionAgenteGeneral = function (res, departamentoId, reparaciones, con, done) {
    ...
    async.eachSeries(regs, function (r, callback) {
        ...
        // El anticipo queda registrado aunque no haya pagos.
        // Solo se descuenta cuando los hay.
        var descontarAnticipo = hayPagos && anticipo !== 0;
...
var procesaLiquidacionesObras = function (dFecha, hFecha, con, done) {
    ...
    con.query(sql, function (err, res) {
        ...
        con.query(sql, function (err, res) {
            ...
            sql += " l.anticipo + lo.anticipoAnterior AS anticipo,";
...
var calculaLiquidacionObras = function (r, dFecha, hFecha) {
    ...
    //SI SE HAN PAGADO LOS TRES CONCEPTOS DESCONTAMOS EL ANTICIPO
    if (pagado30 && pagado20 && pagado50) basePeriodo = basePeriodo - r.anticipo
