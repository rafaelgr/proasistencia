    ...
    var obj = 
        {
            ...
            sql += " liq.IC,";
            sql += " liq.coste,";
            sql += " COALESCE(cnt.certificacionFinal - liq.CA, 0) AS certificacionNeta,";
            sql += " COALESCE((cnt.certificacionFinal - liq.CA) - liq.coste, 0) AS BI,";
            sql += " COALESCE(((cnt.certificacionFinal - liq.CA) - liq.coste)/liq.coste, 0) AS porBI,";
