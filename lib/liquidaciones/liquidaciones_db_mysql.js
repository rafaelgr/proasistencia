...
module.exports.getLiquidacionAcumulada = function (dFecha, hFecha, tipoComercialId, done) {
...
module.exports.postFacturaLiquidacion = function (dFecha, hFecha, tipoContratoId, empresaId, tipoComercialId, done) {
    var con = getConnection();
    var sql = "";
    con.beginTransaction(function (err) {
        ...
        sql += " (SELECT facturaId FROM facturas AS f";
...
module.exports.checkFacturasLiquidadas = function (dFecha, hFecha, tipoContratoId, empresaId, tipoComercialId, done) {
    var con = getConnection();
    var sql = "SELECT * ";
