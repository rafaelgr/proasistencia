...
module.exports.postPrepararCorreos = function (dFecha, hFecha, clienteId, mantenedorId, comercialId, contratoId, empresaId, departamentoId, usuarioId, done) {
    crearPdfsLiquidacion(dFecha, hFecha, clienteId, mantenedorId, comercialId, contratoId, empresaId, departamentoId, usuarioId, (err, facturas) => {
        if (err) return done(err);
        done(null, facturas);
    });
}
...
var crearPdfsLiquidacion = function (dFecha, hFecha, clienteId, mantenedorId, comercialId, contratoId, empresaId, departamentoId, usuarioId,callback) {
    var con = getConnection();
    var facturas = null;
    var facturas2 = [];
