    ...
    con.beginTransaction(function (err) {
        ...
        */
        con.query(sql, function (err, res) {
            ...
            sql += " DATE_FORMAT(f.fecha, '%y-%m-%d') AS fecha, DATE_FORMAT( '2021-10-01', '%y-%m-%d') AS inicioPeriodo,";
            sql += " DATE_FORMAT( '2021-12-31', '%y-%m-%d') AS finPeriodo, f.serie, f.ano, f.numero, f.totalAlCliente, f.coste,";
