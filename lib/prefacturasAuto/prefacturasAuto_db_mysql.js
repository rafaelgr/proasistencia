...
module.exports.getPrefacturasauto = function (callback) {
...
module.exports.getPrefacturasautoContrato = function (contratoId, callback) {
    var connection = getConnection();
    var prefacturasauto = null;
    sql = "SELECT pf.*,";
    sql += " CONCAT(COALESCE(pf.ano,' '),'-',COALESCE(CAST(pf.serie AS CHAR(50)),' '),'-',COALESCE(CAST(pf.numero AS CHAR(50)),' ')) AS vNum,";
...
module.exports.getPrefacturasautoContratoGeneradas = function (contratoId, callback) {
    var connection = getConnection();
    var prefacturasauto = null;
    sql = "SELECT pf.*,";
    sql += " CONCAT(COALESCE(pf.ano,' '),'-',COALESCE(CAST(pf.serie AS CHAR(50)),' '),'-',COALESCE(CAST(pf.numero AS CHAR(50)),' ')) AS vNum,";
...
module.exports.deletePrefacturasautoContratoGeneradas = function (contratoId, callback) {
    var connection = getConnection();
    var prefacturasauto = null;
...
// getPrefacturasautoAll
// lee todos los registros de la tabla prefacturasauto y
// los devuelve como una lista de objetos
module.exports.getPrefacturasautoAll = function (callback) {
    var connection = getConnection();
    var prefacturasauto = null;
    sql = "SELECT pf.*,";
    sql += " CONCAT(COALESCE(pf.ano,' '),'-',COALESCE(CAST(pf.serie AS CHAR(50)),' '),'-',COALESCE(CAST(pf.numero AS CHAR(50)),' ')) AS vNum,";
...
// getPreEmisionPrefacturasauto
// obtiene las prefacturasauto no facturadas entre las fechas indicadas
module.exports.getPreEmisionPrefacturasauto = function (dFecha, hFecha, clienteId, agenteId, articuloId, tipoMantenimientoId, callback) {
    var connection = getConnection();
    var prefacturasauto = null;
...
// getPreContaPrefacturasauto
// obtiene las prefacturasauto no contabilizadas entre las fechas indicadas
module.exports.getPreContaPrefacturasauto = function (dFecha, hFecha, departamentoId, usuarioId, callback) {
    var connection = getConnection();
    var prefacturasauto = null;
...
// getPreCorreoPrefacturasauto
// obtiene las prefacturasauto no enviadas entre las fechas indicadas
module.exports.getPreCorreoPrefacturasauto = function (dFecha, hFecha, clienteId, mantenedorId, comercialId, contratoId, empresaId, departamentoId, usuarioId,callback) {
    var connection = getConnection();
    var prefacturasauto = null;
...
// getPreLiquidacionPrefacturasauto
// obtiene las prefacturasauto no contabilizadas entre las fechas indicadas
module.exports.getPreLiquidacionPrefacturasauto = function (dFecha, hFecha, departamentoId, empresaId, comercialId, usuarioId, callback) {
    var connection = getConnection();
    var prefacturasauto = null;
    var sql = "";
...
/*module.exports.postContabilizarPrefacturasauto = function (dFecha, hFecha, done) {
    var con = getConnection();
    var sql = "";
...
module.exports.postContabilizarPrefacturasauto = function (dFecha, hFecha, departamentoId, usuarioId,done) {
    var con = getConnection();
    var sql = "SELECT f.*";
    sql += " FROM prefacturasauto as f";
    sql += " WHERE f.fecha >= ? AND f.fecha <= ?";
    ...
    con.query(sql, function (err, rows) {
        con.end();
        if (err) return done(err);
        contabilidadDb.contabilizarPrefacturasauto(rows, function (err, result) {
            if (err) return done(err);
            if(result.length > 0) {
                done(null, result)
            } else {
...
module.exports.postFacturaLineaDesdeParte = function (prefacturaAutoId, lineaParteId, callback) {
    var connection = getConnection();
...
// deletePrefacturasautoContrato
// Elimina todas las prefacturasauto pertenecientes a un contrato.
module.exports.deletePrefacturasautoContrato = function (id, callback) {
    var connection = getConnection();
...
module.exports.postDesmarcarFactura = function (id, done) {
    var con = getConnection();
    sql = "UPDATE prefacturas SET prefacturaAutoId = NULL WHERE prefacturaAutoId = ?";
    sql = mysql.format(sql, id);
...
module.exports.postDescontabilizar = function (id, done) {
    var con = getConnection();
    sql = "UPDATE prefacturasauto SET contabilizada = 0 WHERE prefacturaAutoId = ?";
    sql = mysql.format(sql, id);
    con.query(sql, function (err, data) {
        con.end();
        if (err) return done(err);
...
var fnGetNumeroFactura = function (prefacturaAuto, done) {
    ...
    con.query(sql, function (err, res) {
        ...
        con.query(sql, function (err, res) {
            ...
            fnComprobarOrdenCorrecto(prefacturaAuto.empresaId, prefacturaAuto.serie, prefacturaAuto.ano, prefacturaAuto.fecha, function (err, res) {
                if (err) return done(err);
                    ...
                    async.series([
                        ...
                        function(callback) {//ACTUALIZAMOS EL PARTE CON EL NUMERO E ID DE LA PREFACTURA CORRESPONDIENTE 
                            async.eachSeries(partesActualiza, function (f, done3) {
                                ...
                                sql3 = mysql.format(sql3, [numFact, fechaFactura, sel.prefacturaAutoId, f.parteId]);
                                    con.query(sql3, function(err, res) {
                                        if (err) return done3(err);
                                        done3(null);
...
var fnGetNumeroFacturaTrans = function (prefacturaAuto, con, done) {
    ...
    con.query(sql, function (err, res) {
        ...
        fnComprobarOrdenCorrecto(prefacturaAuto.empresaId, serie, ano, prefacturaAuto.fecha, function (err, res) {
            if (err) return done(err);
            sql = "SELECT COALESCE(MAX(numero) + 1, 1) AS n FROM prefacturasauto";
            sql += " WHERE empresaId = ?";
            sql += " AND ano = ?";
...
// lee todos los registros de la tabla prefacturasauto que no estén facturadosy
// los devuelve como una lista de objetos
module.exports.getPrefacturasautoUsuario = function (usuarioId, departamentoId, callback) {
    var connection = getConnection();
    var prefacturasauto = null;
    sql = "SELECT pf.*,";
    sql += " CONCAT(COALESCE(pf.ano,' '),'-',COALESCE(CAST(pf.serie AS CHAR(50)),' '),'-',COALESCE(CAST(pf.numero AS CHAR(50)),' ')) AS vNum,";
    ...
    sql += " LEFT JOIN clientes as c ON c.clienteId = cm.clienteId";
    sql += " WHERE pf.contafich IS NULL AND pf.contabilizada = 0";
    if(departamentoId > 0) {
...
// lee todos los registros de la tabla prefacturasauto y
// los devuelve como una lista de objetos
module.exports.getPrefacturasautoAllUsuario = function (usuarioId, departamentoId, callback) {
    var connection = getConnection();
    var prefacturasauto = null;
    sql = "SELECT pf.*,";
    sql += " CONCAT(COALESCE(pf.ano,' '),'-',COALESCE(CAST(pf.serie AS CHAR(50)),' '),'-',COALESCE(CAST(pf.numero AS CHAR(50)),' ')) AS vNum,";
...
// lee todos los registros de la tabla prefacturasauto y
// los devuelve como una lista de objetos
module.exports.getPrefacturasautoReparaciones = function (callback) {
    var connection = getConnection();
    var prefacturasauto = null;
    sql = "SELECT pf.*,";
...
module.exports.postCrearDesdePrefacturasUsuario = function (dFecha, hFecha, fechaFactura, usuarioId, clienteId, agenteId, departamentoId, empresaId, rectificativas,done) {
    ...
    con.beginTransaction(function (err) {
        if (err) return done(err);
        // obtener las prefacturas que han de pasarse a prefacturaAuto
        sql = "SELECT pf.*, pf.totalConIva as restoCobrar  FROM prefacturas as pf";
        sql += " LEFT JOIN clientes as c ON c.clienteId = pf.clienteId"
        sql += " LEFT JOIN contratos as cm ON cm.contratoId = pf.contratoId"
        sql += " WHERE pf.fecha >= ? AND pf.fecha <= ?";
        sql += " AND pf.prefacturaAutoId IS NULL AND pf.sel = 1";
                ...
                async.series([
                    function (callback) {
                        ...
                        fnGetNumeroFacturaTrans(pf, con, function (err, res) {
                            if (err) return callback(err);
                            prefacturaAuto = res;
                            numFact = prefacturaAuto.serie + "-" + prefacturaAuto.ano + "-" + prefacturaAuto.numero;
                            callback(null);
                        }, con);
                    },
                    function (callback) {
                        // insertar la cabecera
                        delete prefacturaAuto.contratoPorcenId // eliminamos campo no necesario
                        sql = "INSERT INTO prefacturasauto SET ?";
                        sql = mysql.format(sql, prefacturaAuto);
                        con.query(sql, function (err, result) {
                            if (err) return callback(err);
                    ...
                    function(callback) {
                        ...
                        if(prefacturaAuto.departamentoId == 7 && !prefacturaAuto.contratoId) {
                            sql = "UPDATE partes SET numero_factura_cliente = ?, fecha_factura_cliente = ?, prefacturaAutoId = ? WHERE prefacturaId = ?"
                            sql = mysql.format(sql, [numFact, prefacturaAuto.fecha, prefacturaAuto.prefacturaAutoId, prefacturaAuto.prefacturaId]);
                            con.query(sql, function (err, result) {
                                if (err) return callback(err);
                                ...
                                sql += " ser.servicioId = p.servicioId AND p.parteId = pl.parteId AND  p.prefacturaId = ? AND p.prefacturaAutoId = ?";
                                sql = mysql.format(sql, [prefacturaAuto.prefacturaId, prefacturaAuto.prefacturaAutoId]);
                                con.query(sql, function (err, result2) {
                                    ...
                                    async.forEachSeries(ids, function (id, done) {
                                        ...
                                        sql = " UPDATE partes_lineas set prefacturaAutoLineaId = ? WHERE prefacturaLineaId = ?";
...
module.exports.getPrefacturasautoCliente = function (clienteId, callback) {
    var connection = getConnection();
...
module.exports.getPrefacturasautoClienteAgenteDepartamento = function (id, departamentoId, esCliente, callback) {
    var connection = getConnection();
...
// obtenerPrefacturasautoParaCorreo
var obtenerPrefacturasautoParaCorreo = (dFecha, hFecha, done) => {
    var con = getConnection();
    var sql = "SELECT ";
