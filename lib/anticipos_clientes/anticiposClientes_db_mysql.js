...
module.exports.BorrarAntclienDesdeParte = function (numeroAntclien, clienteId, done) {
    var con = getConnection();
    var sql = "";
    var antclien;
    ...
    con.beginTransaction(function (err) {
        ...
        sql += " WHERE ant.numeroAnticipoCliente = ? AND ant.clienteId = ?";
        sql = mysql.format(sql, [numeroAntclien, clienteId]);
