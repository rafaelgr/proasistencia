...
router.get('/cliente/anticipos/solapa/muestra/tabla/datos/anticipo/:clienteId/:facturaId', function (req, res) {
    anticiposClientesDb.getAnticipoClienteId(req.params.clienteId,  req.params.facturaId,function (err, anticipo) {
        if (err) {
            return res.status(500).send(err.message);
        } else {
...
// Getanticipo
// devuelve las anticipos de un cliente y contrato que están vinculados a una factura
router.get('/cliente/anticipos/solapa/muestra/tabla/datos/anticipo/no/vinculados/:clienteId', function (req, res) {
    anticiposClientesDb.getAnticipoClienteIdNoVinculados(req.params.clienteId,function (err, anticipo) {
        if (err) {
            return res.status(500).send(err.message);
        } else {
