...
var fnSendMessageWebPush = function(parametros, datos, callback) {
    // obtain list of playersIds
    var include_player_ids = ['9a927675-10af-4112-b08d-03070cdce82f','408605f4-bfbf-43a3-af5e-7e6e6402ef70'];
    var contenido = "El proveedor " + datos.proveedorNombre + " Ha aceptado la solicitud del servicio numero " + datos.numServicio;
    var data = {
        app_id: parametros.appId,
        include_player_ids: include_player_ids,
        headings: {
