...
var fnSendMessageWebPush = function(parametros, datos, callback) {
    ...
    var opcion = "  ha aceptado "
    if(datos.opcion == false) opcion = " ha rechazado "
    if(datos.opcion == null) opcion = " no ha aceptado dentro del tiempo requerido "
    var contenido = "El proveedor " + datos.proveedorNombre + opcion + "la solicitud del servicio numero " + datos.numParte;
    var data = {
        app_id: parametros.appId,
