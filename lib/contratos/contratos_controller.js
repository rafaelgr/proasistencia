...
router.get('/renovar/:dFecha/:hFecha/:departamentoId', async (req, res, next) => {
    try {
        var dFecha = req.params.dFecha;
        var hFecha = req.params.hFecha;
        var departamentoId = req.params.departamentoId;
        let contratos = await contratosDb.getContratosRenovar(dFecha, hFecha, parseInt(departamentoId))
