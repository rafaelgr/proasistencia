...
router.get('/inf/contratos/json/visor/:dFecha/:hFecha/:empresaId/:clienteId/:departamentoId/:agenteId/:facturaId', function (req, res) {
    var dFecha = req.params.dFecha;
    var hFecha = req.params.hFecha;
    var departamentoId = req.params.departamentoId;
    var empresaId = req.params.empresaId;
    ...
    var clienteId = req.params.clienteId;
    contratosDb.getContratosObj(dFecha, hFecha, parseInt(facturaId), parseInt(empresaId), parseInt(clienteId), parseInt(agenteId), parseInt(departamentoId), function (err, facturas) {
        if (err) return res.status(500).send(err.message);
        res.json(facturas);
    });
})
...
router.get('/inf/contratos/json/visor/:dFecha/:hFecha/:empresaId/:clienteId/:departamentoId/:tipoComercialId/:comercialId', async (req, res, next) => {
    var dFecha = req.params.dFecha;
    var hFecha = req.params.hFecha;
    var departamentoId = req.params.departamentoId;
    var empresaId = req.params.empresaId;
    ...
    var clienteId = req.params.clienteId;
    try {
        contratosDb.getContratosObj(dFecha, hFecha, parseInt(empresaId), parseInt(clienteId), parseInt(departamentoId), parseInt(tipoComercialId), parseInt(comercialId))
        .then( (result) => {
            res.json(result);
