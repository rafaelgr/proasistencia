...
router.post('/actualizar/varios/:dFecha/:hFecha/:fechaRenovacionIpc/:ipc/:departamentoId/:preaviso', async (req, res, next) => {
    try {
        ...
        let result = await contratosDb.putActualizarContratos(dFecha, hFecha, fechaRenovacionIpc, ipc, departamentoId, preaviso);
        res.json(result);
