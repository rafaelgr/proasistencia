...
router.post('/importa/palnificacion/lineas/temporales/:contratoId/:contratoInteresesId', async (req, res, next) => {
    var contratoId = req.params.contratoId
    var contratoInteresesId = req.params.contratoInteresesId
    try {
        let planificacion = await contratosDb.getPlanificacionLineasTemp(contratoId);
