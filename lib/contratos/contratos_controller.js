...
router.get('/documentacion/:contratoId/:departamentoId', async (req, res, next) => {
    try {
        contratosDb.getContratoDocumentacion(req.params.contratoId, req.params.departamentoId)
        .then((docum) => {
...
router.post('/documentacion', async (req, res, next) => {
    try {
        contratosDb.postContratoDocumentacion(req.body.contratoDocumentacion)
        .then((docum) => {
            res.json(docum)
        })
        .catch(err => next(err));
