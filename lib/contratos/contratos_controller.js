...
router.post('/actualizar/varios/:dFecha/:hFecha/:departamentoId/:preaviso', async (req, res, next) => {
    try {
        ...
        let result = await contratosDb.putActualizarContratos(dFecha, hFecha, departamentoId, preaviso);
        res.json(result);
