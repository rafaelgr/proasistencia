...
router.post('/renovar/varios/:nuevaFechaInicio/:nuevaFechaFinal/:nuevaFechaContrato/:dFecha/:hFecha/:departamentoId/:preaviso', async (req, res, next) => {
    try {
        var antContratoId = req.params.antContratoId;
        var nuevaFechaInicio = req.params.nuevaFechaInicio;
        var nuevaFechaFinal = req.params.nuevaFechaFinal;
        ...
        let result = await contratosDb.postRenovarContratos(nuevaFechaInicio, nuevaFechaFinal, nuevaFechaContrato, dFecha, hFecha, departamentoId, preaviso);
        res.json(result);
