...
router.put('/trabajo/adicional', async (req, res, next) => {
    try {
        contratosDb.putTrabajoAdicional(req.body.adicional)
            .then((result) => {
                res.json(result);
...
router.delete('/trabajo/adicional', async (req, res, next) => {
    try {
        contratosDb.deleteTrabajoAdicional(req.body.adicionalId)
            .then((result) => {
                res.json(result);
