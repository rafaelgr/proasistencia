...
module.exports.postContrato = function (contrato, done) {
    actualizarEnBaseDeDatos('POST',contrato, done);
}

module.exports.putContrato = function (contrato, done) {
    actualizarEnBaseDeDatos('PUT', contrato, done);
}

module.exports.deleteContrato = function (contrato, done) {
    actualizarEnBaseDeDatos('DELETE', contrato, done);
}
...
module.exports.getContratoLineas = function (id, callback) {
    var connection = cm.getConnection();
    var contratos = null;
    sql = "SELECT cntl.*, a.grupoArticuloId FROM contratos_lineas as cntl";
...
// private functions
var actualizarEnBaseDeDatos = function (comando, contrato, done) {
    cm.getConnectionCallback(function (err, con) {
        if (err) return done(err);
        var sql = "";
        switch (comando) {
            ...
            case 'PUT':
                ...
                break;
            case 'DELETE':
                sql = "DELETE FORM contratos WHERE contratoId = ?";
