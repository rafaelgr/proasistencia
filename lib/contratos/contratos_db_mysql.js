...
//-------------------------------
module.exports.getContratosObj = async (dFecha, hFecha, empresaId, clienteId, departamentoId, tipoComercialId, comercialId) => {
    let con = null;
    var sql;
    return new Promise(async (resolve, reject) => {
        try {
            ...
            sql +=" COALESCE(c.certificacionFinal),";
