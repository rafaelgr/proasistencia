...
module.exports.postCrearReport = async (contratoId) => {
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            sql = " SELECT ";
            sql += " c.contratoId,";
            sql += " c.direccion AS direccionTrabajo,";
            sql += " c.codPostal AS codPostalTrabajo,";
            sql += " c.provincia AS provinciaTrabajo,";
            sql += " c.poblacion AS poblacionTrabajo,";
            ...
            sql += " cli.nombrePresidente,";
            sql += " cli.dniPresidente,";
            sql += " cli.correoPresidente";
            sql += " FROM contratos AS c ";
            sql += " LEFT JOIN tipos_proyecto AS tp ON tp.tipoProyectoId = c.tipoProyectoId";
            sql += " LEFT JOIN clientes AS cli ON cli.clienteId = c.clienteId";
