...
module.exports.postCrearReport = async (contratoId) => {
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            sql += " COALESCE(cli.nombrePresidente, '') AS nombrePresidente,";
            sql += " COALESCE(cli.dniPresidente, '') AS dniPresidente,";
            sql += " COALESCE(cli.correoPresidente, '') AS correoPresidente";
            sql += " FROM contratos AS c ";
            sql += " LEFT JOIN tipos_proyecto AS tp ON tp.tipoProyectoId = c.tipoProyectoId";
            sql += " LEFT JOIN clientes AS cli ON cli.clienteId = c.clienteId";
            ...
            for (let pr of obj.datos_contrato_letras) {
                for (let pi of obj.datos_contrato_Intereses) {
                    ...
                    console.log(pr.sumTotalAlcliente);
                    console.log(pr.sumTotalConIva);
                    break;
                }
            }
            resolve(obj)
