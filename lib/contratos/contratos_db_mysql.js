        ...
        try {
            ...
            Object.entries(letrasAgrupadas).forEach(([contPlanificacionId, grupo]) => {
                ...
                if (grupo.length === 1 && grupo[0].numletras === 1) {
                    ...
                    textoNarrativa = `${formatearImporte(total)}€, mediante 1 letra de cambio debidamente firmada y domiciliada en la Cta. Cte. de la Comunidad ES1100817118510001287730, por un importe de ${importeUnitario}€, siendo su vencimiento del ${fechaInicio}.`;
                } else {
                    ...
                    if (importeUnitario === importeUltima) {
                        textoNarrativa = `${formatearImporte(total)}€, mediante ${numLetras} letras de cambio debidamente firmadas y domiciliadas en la Cta. Cte. de la Comunidad ES1100817118510001287730, por un importe de cada una de ellas de ${importeUnitario}€, siendo sus vencimientos del ${fechaInicio} al ${fechaFin}.`;
                    } else {
                        textoNarrativa = `${formatearImporte(total)}€, mediante ${numLetras} letras de cambio debidamente firmadas y domiciliadas en la Cta. Cte. de la Comunidad ES1100817118510001287730, por un importe de las ${numPrimeras} primeras de ${importeUnitario}€ y la número ${numLetras} de ${importeUltima}€, siendo sus vencimientos del ${fechaInicio} al ${fechaFin}.`;
                    }
                }
