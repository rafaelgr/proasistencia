...
var fnActualizarTotales = function (id, callback) {
    ...
    sql += " (SELECT contratoId, SUM(coste) AS sc,  porcentajeBeneficio AS pb, porcentajeAgente AS pa";
    ...
    sql += ' cnt.porcentajeBeneficio = cnt3.pb,';
    sql += ' cnt.porcentajeAgente = cnt3.pa';
    sql += " WHERE cnt.contratoId = ?";
