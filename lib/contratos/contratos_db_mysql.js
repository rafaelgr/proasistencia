        ...
        try {
            ...
            await con.beginTransaction();
                ...
                for(let contrato of contratos) {
                    ...
                    contrato.referencia = fnCrearNuevaReferencia(contrato.referencia);
                    // Dar de alta el nuevo contrato con los valores pasados.
                    let result2 = await fnCrearContratoDesdeOtro2(con, contrato, antContratoId, nuevaFechaInicio, nuevaFechaFinal, nuevaFechaContrato, nuevaFechaPrimeraFactuna);
...
let fnCrearContratoDesdeOtro2 = async (con, contrato, antContratoId, nuevaFechaInicio, nuevaFechaFinal, nuevaFechaContrato, nuevaFechaPrimeraFactuna) => {
    return new Promise(async (resolve, reject) => {
        try {
