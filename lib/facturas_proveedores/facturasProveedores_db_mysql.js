...
module.exports.getFacturasContrato = function (contratoId, callback) {
    ...
    sql += " LEFT JOIN formas_pago AS fp ON fp.formaPagoId = pf.formaPagoId";
    sql += " LEFT JOIN contratos as cm ON cm.contratoId = pf.contratoId"
    sql += " LEFT JOIN clientes as c ON c.empresaId = cm.empresaId";
...
module.exports.getNuevaIdFacprove = function (callback) {
    var connection = getConnection();
    var proveedores = null;
    sql = "SELECT COALESCE(MAX(facproveId) +1, 1) facproveId FROM facprove";
    connection.query(sql, function (err, result) {
        closeConnectionCallback(connection, callback);
        if (err) {
            return callback(err, null);
...
module.exports.postFactura = function (facprove, callback) {
...
module.exports.putFactura = function (id, facprove, callback) {
    if (!comprobarFacprove(facprove)) {
