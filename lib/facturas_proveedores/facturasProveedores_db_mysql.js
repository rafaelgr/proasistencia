...
var fnGetNumeroFacprove = function (facprove, done) {
    ...
    sql = "SELECT COUNT(*) AS n FROM facprove";
...
module.exports.postLineasDesdeAntprove= function (facproveId, antproveId, callback) {
    ...
    connection.query(sql, function (err, facprove_li) {
            ...
            if (err) {
                ...
                facprove_li[0].facproveId = facproveId
                
                delete facprove_li[0].antproveId;
                delete facprove_li[0].antproveLineaId
                
                sql = "INSERT INTO facprove_lineas SET ? ";
                sql = mysql.format(sql, facprove_li);
                connection.query(sql, function (err, facprove_li) {
                    ...
                    if (err) {
                        ...
                        connection.query(sql, function (err, facprove_bases) {
                            ...
                            if (err) {
                                ...
                                facprove_bases[0].facproveId = facproveId
                
                                delete facprove_bases[0].antproveId;
                                delete facprove_bases[0].antproveBaseId;

                                sql = "INSERT INTO facprove_bases SET ? ";
                                sql = mysql.format(sql, facprove_bases);
                                connection.query(sql, function (err, facprove_li) {
                                    ...
                                    if (err) {
                                        ...
                                        connection.query(sql, function (err, facprove_reten) {
                                            ...
                                            if (err) {
                                                ...
                                                facprove_reten[0].facproveId = facproveId
                                
                                                delete facprove_reten[0].antproveId;
                                                delete facprove_reten[0].antproveRetencionId;
                                                
                                                sql = "INSERT INTO facprove_retenciones SET ? ";
                                                sql = mysql.format(sql, facprove_reten);
                                                connection.query(sql, function (err, result) {
                                                    ...
                                                    if (err) {
                                                        ...
                                                        connection.query(sql, function (err, facprove_serv) {
                                                            ...
                                                            if (err) {
                                                                ...
                                                                facprove_serv[0].facproveId = facproveId
                                                
                                                                delete facprove_serv[0].antproveId;
                                                                delete facprove_serv[0].antproveServiciadoId;
                                                                
                                                                sql = "INSERT INTO facprove_serviciados SET ? ";
                                                                sql = mysql.format(sql, facprove_serv);
                                                                connection.query(sql, function (err, result) {
                                                                    connection.end();
                                                                    if (err) {
                                                                        return callback(err);
