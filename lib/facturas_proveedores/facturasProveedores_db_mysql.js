...
module.exports.postFacturaLineaDesdeParte = function (facproveId, lineaParteId, callback) {
    var connection = getConnection();
    sql = "SELECT par.facproveId, pt.descripcion AS descripcion, pt.unidades AS cantidad,ar.articuloId AS articuloId,pt.tipoIvaProveedorId AS tipoIvaId, pt.ivaProveedor AS porcentaje, ar.unidadId,";
    sql += " pt.precioProveedor AS importe,  pt.importeProveedor AS coste, pt.importeProveedor AS totalLinea ,ga.nombre AS capituloLinea ";
    sql += " FROM partes AS par";
...
module.exports.postCrearFactProDesdeParte = function (seleccionados, deFecha, aFecha, fechaFactura, done) {
    ...
    sql2 += " (SUM(par.importe_profesional_iva) - SUM(par.aCuentaProfesional)) AS totalConIva, 7 AS departamentoId, 0 AS importeAnticipo,";
    ...
    sql2 += " (par.importe_profesional_iva - par.aCuentaProfesional) AS totalConIva, 7 AS departamentoId, 0 AS importeAnticipo,";
...
module.exports.getFacturasProveedoresUsuario = function (usuarioId, departamentoId, callback) {
    ...
    sql += " ORDER BY pf.ref DESC, pf.fecha_recepcion DESC";
    connection.query(sql, function (err, result) {
        connection.end();
        if (err) {
            return callback(err, null);
