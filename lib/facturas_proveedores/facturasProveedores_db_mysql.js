...
module.exports.putFacturaCabDesdeParte = function (datos, callback) {
    var facproveId;
    var connection = getConnection();
    sql = "SELECT SUM(aCuentaProfesional) AS importeAnticipo";
    sql += " FROM partes";
    sql += " WHERE facproveId = ?";
    sql += " GROUP BY facproveId";
...
module.exports.postCrearFactProDesdeParte = function (seleccionados, deFecha, aFecha, fechaFactura, done) {
    ...
    sql2 += " pro.`nombre` AS emisorNombre, pro.`nif` AS emisorNif, pro.`codPostal` AS emisorCodPostal,";
    sql2 += " pro.`poblacion` AS emisorPoblacion, pro.`provincia` AS emisorProvincia, ser.`direccionTrabajo` AS emisorDireccion,";
                    ...
                    function (callback) {
                        ...
                        con.query(sql, function (err, res) {
                            ...
                            lineasFactura.forEach(function (l) {
                                ...
                                delete l.parteLineaId //borramos la propiedad ya que no nos hace falta para crear la linea de factura
                                cont++;
                        ...
                        async.eachSeries(lineasFactura, function (f, done2) {
                            ...
                            if(f.anticipo > 0) {
                                ...
                                var   antprove = {
                                        ...
                                        "fecha": cabFacturas.fecha,
                                        "fecha_recepcion": cabFacturas.fecha_recepcion,
                                        "empresaId": cabFacturas.empresaId,
                                        //"empresaId2": vm.sempresaServiciadaId(),
                                        "proveedorId": cabFacturas.proveedorId,
                                        "emisorNif": cabFacturas.emisorNif,
                                        "emisorNombre": cabFacturas.emisorNombre,
                                        "emisorDireccion": cabFacturas.emisorDireccion,
                                        "emisorCodPostal": cabFacturas.emisorCodPostal,
                                        "emisorPoblacion": cabFacturas.emisorPoblacion,
                                        "emisorProvincia": cabFacturas.emisorProvincia,
                                        "receptorNif": cabFacturas.receptorNif,
                                        "receptorNombre": cabFacturas.receptorNombre,
                                        "receptorDireccion": cabFacturas.receptorDireccion,
                                        "receptorCodPostal": cabFacturas.receptorCodPostal,
                                        "receptorPoblacion": cabFacturas.receptorPoblacion,
                                        "receptorProvincia": cabFacturas.receptorProvincia,
                                        "total": 0,
                                        "totalConIva":  f.anticipo,
                                        "formaPagoId": cabFacturas.formaPagoId,
                                        //"observaciones": cabfac.observaciones(),
                                        "coste": 0,
                                        "porcentajeAgente": 0,
                                ...
                                con.query(sql2, function (err, res) {
                                    ...
                                    var sql3 = "INSERT INTO antprove SET ?"
                                    sql3 = mysql.format(sql3, data);
