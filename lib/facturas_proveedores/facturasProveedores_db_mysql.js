...
module.exports.putFacturaCabDesdeParte = function (datos, callback) {
    var facproveId;
    var connection = getConnection();
    var sql = "SELECT par.formaPagoProfesionalId AS formaPagoId";
    sql += " ,SUM(par.aCuentaProfesional) as contado, SUM(par.importe_profesional_iva) AS totalConIva";
    sql += " ,SUM(par.importe_profesional) AS coste, SUM(par.importe_profesional) AS total"
    sql += " ,SUM(par.importe_profesional_iva)-SUM(par.aCuentaProfesional)-importeAnticipo-fianza AS restoPagar"
