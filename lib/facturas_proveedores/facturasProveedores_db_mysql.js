...
module.exports.putFacturaCabDesdeParte = function (datos, callback) {
    ...
    sql += " ,SUM(par.aCuentaProfesional) as contado, SUM(fac.totalConIva) as totalConIva";
    sql += " ,SUM(fac.totalConIva)-SUM(par.aCuentaProfesional)-SUM(importeAnticipo)-SUM(fianza) AS restoPagar"
