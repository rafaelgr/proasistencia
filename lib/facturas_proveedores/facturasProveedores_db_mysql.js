...
module.exports.postCrearFactProDesdeParte = function (seleccionados, deFecha, aFecha, fechaFactura, done) {
    ...
    sql = "(SELECT '"+fechaFacturaAno+"' AS ano, '"+fechaFactura+"' AS fecha, par.proveedorId, '"+ periodo +"' AS periodo,  par.parteId, par.factPropiaPro,";
                ...
                async.series([
                    function (callback) {
                        ...
                        con.query(sql, function (err, res) {
                            if (err) return callback(err);
                            numero = res[0].n;
                            sel.ref = fechaFacturaAno +"-"+sel.empresaId+"-"+numero
                            callback(null);
                        });
                    },
                    function (callback) {
                    ...
                    function(callback) {
                         ...
                         sql += " pt.importeProveedor AS importe, pt.importeProveedorIva AS coste, pt.importeProveedor AS totalLinea ,ga.nombre AS capituloLinea ";
                         ...
                         con.query(sql, function (err, res) {
                            ...
                            lineasFactura.forEach( function(l){
                                ...
                                l.linea = "1." + str;
                                //calculamos el iva
                                if(!l.porcentaje) { l.porcentaje = 0}
                                if(l.porcentaje > 0) {
                                    l.totalLinea = (l.porcentaje * l.coste)/100;
                                } else {
                                    l.totalLinea = l.coste;
                                }
