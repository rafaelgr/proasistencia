...
router.post('/linea/nueva/:facproveId/:lineaParteId', function (req, res) {
    var facproveId = req.params.facproveId;
    var lineaParteId = req.params.lineaParteId;
    facturasProveedoresDb.postFacturaLineaDesdeParte(facproveId, lineaParteId, function (err, result) {
