...
router.get('/usuario/logado/departamento/:usuarioId/:departamentoId/:dFecha/:hFecha/:empresaId', function (req, res) {
    facturasProveedoresDb.getFacturasProveedoresUsuario(req.params.usuarioId, req.params.departamentoId, req.params.dFecha, req.params.hFecha, req.params.empresaId, function (err, facturas) {
        if (err) {
            return res.status(500).send(err.message);
        } else {
            res.json(facturas);
...
router.get('/usuario/logado/departamento/all/:usuarioId/:departamentoId/:dFecha/:hFecha/:empresaId', function (req, res) {
    facturasProveedoresDb.getFacturasAllUsuario(req.params.usuarioId, req.params.departamentoId, req.params.dFecha, req.params.hFecha, req.params.empresaId, function (err, facturas) {
        if (err) {
            return res.status(500).send(err.message);
        } else {
            res.json(facturas);
