...
module.exports.generarContratoDesdeOferta = function (ofertaId, datosAceptacion, done) {
    ...
    cm.getConnectionCallbackTransaction(function (err, con) {
        ...
        async.series({
            insertarCabeceraNuevoContrato: function (callback) {
            ...
            insertarLineasNuevoContrato: function (callback) {
                // insertar las líneas del nuevo contratos

            },
            insertarBasesNuevoContrato: function (callback) {
                // insertar las bases del nuevo contraro

            },
            crearComisionistasNuevoContrato: function (callback) {
                // crear como comisionista el colaborador asociado al agente con su comisión

            },
            actualizarCabeceraOferta: function (callback) {
                // actualizar la cabecera de oferta con el identificador de contrato y la fecha de aceptación
