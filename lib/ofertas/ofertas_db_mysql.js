...
module.exports.getOfertasExpedienteAceptadas = function ( expedienteId, esCoste, done) {
    cm.getConnectionCallback(function (err, con) {
        ...
        sql = "SELECT DISTINCT c.contratoId, c.ofertaId, o2.ofertaId AS ofertaCosteId, o2.referencia, o3.ofertaId AS ofertaSubcontrataId, CONCAT( '#', COALESCE(o3.referencia, '')) AS referenciaSubcontrata FROM contratos AS c"
        sql += " LEFT JOIN ofertas AS o ON o.ofertaId = c.ofertaId ";
        ...
        sql += " WHERE o.tipoOfertaId = " + 5 + " AND c.ofertaId IN (";
        sql += " SELECT ofertaId FROM ofertas" + subsql +"  AND expedienteId = " + expedienteId + ")";
...
var insertarCabeceraNuevaOfertaSubcontrata = function (ofertaId, con, done) {
    module.exports.getOferta(ofertaId, function (err, ofertas) {
        ...
        con.query(sql, function (err, res) {
            ...
            nuevaOferta.beneficioLineal = 0;
            nuevaOferta.referencia = nuevaOferta.referencia.replace(/_PC_/g, '_PS_');
            sql = "INSERT INTO ofertas SET ?";
