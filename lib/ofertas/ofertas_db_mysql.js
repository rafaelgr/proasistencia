...
module.exports.getOfertaLineasMovil = async (id) => {
    let con = null;
    return new Promise(async (resolve, reject) => {
        try {
            con = await mysql2.createConnection(obtenerConfiguracion());
        ...
        try {
            ...
            if(result) {
                let ofertaLinea = {
                    ...
                    //
                    unidades: o.cantidad,
                    precioCliente: o.importe,
                    importeCliente:o.totalLinea,
                    importeCliente: o.coste,
                    perdto: o.perdto,
                    dto: o.dto,
                    importeCliente: o.precio,
                    ...
                    //
                    precioProveedor: o.importeProveedor,
                    importeProveedor: o.totalLineaProveedor,
                    importeProveedor: o.costeLineaProveedor,
                    perdtoProveedor: o.perdtoProveedor,
                    dtoProveedor: o.dtoProveedor,
                    importeProveedor: o.precioProveedor,
                    importeProveedorIva: o.totalLineaProveedorIva,
...
module.exports.getOfertasProveedor = async (proveedorId, asignados, /* fecha, hFecha,direccionTrabajo, */) => {
	let con = null;
    var ofertas = null;
    return new Promise(async (resolve, reject) => {
        try {
            ...
            var sql = "SELECT o.*, c.nombre AS cliNombre";
            ...
            if(asignados == 'false') { sql += " AND servicioId IS NULL " };
        
        
            //if(fecha != 'null' && hFecha != 'null') sql += " AND o.fechaOferta BETWEEN '" + fecha + " 00:00:00' AND '" + hFecha + " 00:00:00'";
            //if(fecha != 'null' && hFecha == 'null') sql += " AND o.fechaOferta >= '" + fecha + " 00:00:00'";
