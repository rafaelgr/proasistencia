...
// getOfertasProveedor
module.exports.getOfertasProveedor = async (proveedorId, estado, dFecha, hFecha) => {
	let con = null;
    var ofertas = null;
    return new Promise(async (resolve, reject) => {
        try {
...
module.exports.getOfertaParte = async (ref, clienteId) => {
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            var sql = "SELECT * FROM ofertas WHERE referencia = ? AND tipoOfertaId = 7 AND clienteId = ?";
