...
module.exports.putLineasOfertasAsociadas = async function (ofertaLinea, id) {
    ...
    try {
        ...
        let result4 = await procesaOfertaVinculada(l, 0, con);
        ...
        let result7 = await procesaOfertaVinculada(ofertaLinea, 2, con);
...
async function procesaOfertaVinculada(ofertaLinea, esCoste, con) {
  try {
    let sql = "";
    if(esCoste == 0) {
