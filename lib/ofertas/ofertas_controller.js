...
//devuelve las carpetas de un departamento con los documentos que pertenecen a una oferta determinada
router.get('/documentacion/:ofertaId/:departamentoId', async (req, res, next) => {
    try {
        ofertasDb.getOfertaDocumentacion(req.params.ofertaId, req.params.departamentoId)
        .then((docum) => {
...
//devuelve un registro de la table ofertaDocumentacion con su id pasada
router.get('/documentacion/un/documento/:ofertaDocumentoId', async (req, res, next) => {
    try {
...
router.get('/documentacion/documentos/carpeta/:carpetaId', async (req, res, next) => {
    try {
        ofertasDb.getDocumentosCarpeta(req.params.carpetaId)
        .then((docums) => {
...
//inserta un registro en la tabla ofertaDocumentacion
...
//Modifica un registro en la tabla ofertaDocumentacion
router.put('/documentacion/:ofertaDocumentoId', async (req, res, next) => {
    try {
        ofertasDb.putOfertaDocumentacion(req.body.ofertaDocumentacion, req.params.ofertaDocumentoId)
        .then((docum) => {
            res.json(docum)
        })
        .catch(err => next(err));
...
router.delete('/documentacion/elimina-carpeta/:carpetaId', async (req, res, next) => {
    try {
        ofertasDb.deleteOfertaCarpeta(req.params.carpetaId)
        .then((result) => {
            res.json(result)
        })
        .catch(err => next(err));
