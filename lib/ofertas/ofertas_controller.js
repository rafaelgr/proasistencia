...
router.get('/expedientes/tecnicas/:expedienteId/:esCoste', function (req, res) {
    ofertasDb.getOfertasExpediente(req.params.expedienteId, req.params.esCoste, function (err, facturas) {
        if (err) {
            return res.status(500).send(err.message);
        } else {
            res.json(facturas);
...
router.get('/expedientes/tecnicas/aceptadas/:expedienteId/:esCoste', function (req, res) {
