                    ...
                    async.series([
                        ...
                        function(callback) {
                            ...
                            con.query(sql5, function (err, res) {
                                ...
                                var sql6 = "SELECT DISTINCT p.refpresupuesto FROM servicios AS s ";
                                sql6 += " LEFT JOIN partes AS p ON p.servicioId = s.servicioId";
                                ...
                                con.query(sql, function (err, referencias) {
                                    if (err) return callback(err);
                                    if(referencias.length > 0) {
                                        refPresupuestos.push(referencias[i].refPresupuesto);
                                                ...
                                                async.eachSeries(result, function (a, done2) {
                                                    ...
                                                    con.query(sql2, function (err, result2) {
                                                        ...
                                                        if (result2.length == 0) {
                                                            ...
                                                            async.eachSeries(refPresupuestos, function (r, done3) {
