...
var crearCorreosAEnviarReparaciones = (dFecha, hFecha, facturas, done) => {
    ...
    facturas.forEach((factura) => {
        ...
        c1 += " FACTURA: " + factura.nomfich + " IMPORTE: " + factura.totalConIva + "<br/>" + process.env.CLIENTE_CLIEN + "#!/top/facturas?facturaId=" + factura.facturaId + "&empresaId=" + factura.empresaId + "&clienteId=" + factura.clienteId +"<br/>";
...
var buscarFacturas = function (dFecha, hFecha, clienteId, comercialId, empresaId, departamentoId, callback) {
    var con = getConnection();
    var facturas = null;
    sql = "SELECT f.facturaId, f.serie, f.ano, f.numero, f.fecha, f.total, f.totalConIva, f.departamentoId, f.empresaId, f.clienteId,";
    sql += " e.nombre as nombreEmpresa, e.email as correoEmpresa, e.infFacturas, e.infFacCliRep, e.infFacCliObr,";
