...
module.exports.postCrearFactCliDesdeParte = function (seleccionados, deFecha, aFecha, fechaFactura, done) {
    ...
    sql += " cli.`nombreComercial` AS receptorNombre, cli.`nif` AS receptorNif, cli.`codPostal2` AS receptorCodPostal,";
...
module.exports.getFacturasClienteAgenteDepartamento = function (id, departamentoId, esCliente, callback) {
    var connection = getConnection();
    var sql = "SELECT f.*, fp.nombre AS formaPagoNombre FROM facturas AS f";
