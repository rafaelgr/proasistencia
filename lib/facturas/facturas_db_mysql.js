            ...
            async.eachSeries(seleccionados, function (sel, callback2) {
                ...
                async.series([
                    ...
                    function (callback) {
                        ...
                        sql += " 6 AS formaPagoId, par.`importe_cliente` AS coste, par.`importe_cliente` AS totalAlCliente, par.porcentajeBeneficio AS porcentajeBeneficio,";
                        sql += " par.rappel AS porcentajeAgente"
                    ...
                    function(callback) {
                         ...
                         sql += " ti.porcentaje AS porcentaje, pt.importeCliente AS importe, pt.importeCliente AS coste, ga.nombre AS capituloLinea ";
