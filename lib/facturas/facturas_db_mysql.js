                            ...
                            async.eachSeries(lineasFactura, function (f, done2) {
                                ...
                                if(f.anticipo > 0) {
                                    ...
                                    fnGetNumeroantClien(ant, contador,function (err, res) {
                                        ...
                                        var   antClien = {
                                            "antClienId": 0,
                                            "numeroAnticipoCliente": 'ANTI-' + res.ano + "-" + res.numero,
                                            ...
                                            "serie": 'ANTI',//serie provisional mientras se esté en pruebas
                                            "ano": fechaFacturaAno,
                                            "numero": res.numero
...
var fnGetNumeroantClien = function (antClien, contador, done) {
    ...
    sql += " WHERE ano = ? AND empresaId = ? AND serie = 'ANTI'";//serie provisional mientras se esté en pruebas
