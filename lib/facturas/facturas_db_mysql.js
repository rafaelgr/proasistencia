...
// lee todos los registros de la tabla facturas y
// los devuelve como una lista de objetos
module.exports.getFacturasReparacionesFiltros = function (dFecha, hFecha, clienteId, empresaId, callback) {
    var connection = getConnection();
    var deFecha = moment(dFecha, 'DD.MM.YYYY').format('YYYY-MM-DD');
    var aFecha = null;
    if(hFecha == 0) {
        aFecha = parseInt(hFecha);
    } else {
        aFecha = moment(hFecha, 'DD.MM.YYYY').format('YYYY-MM-DD');
    }
