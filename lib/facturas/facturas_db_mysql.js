                ...
                async.eachSeries(cabFacturas, function (sel, callback2) {
                    ...
                    async.series([
                        function (callback) {
                            ...
                            if(!sel.receptorDireccion || sel.receptorDireccion == '') return callback(err);
                            if(!sel.receptorCodPostal || sel.receptorCodPostal == '') return callback(err);
                            if(!sel.receptorPoblacion || sel.receptorPoblacion == '') return callback(err);
                            if(!sel.receptorProvincia || sel.receptorProvincia == '') return callback(err);
