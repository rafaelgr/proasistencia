...
var crearPdfsFactura = function (callback) {
    //Stimulsoft.Base.StiLicense.key = process.env.STI_KEY;
    Stimulsoft.Base.StiFontCollection.addOpentypeFontFile("Roboto-Black.ttf");
    ...
    //CARGAR    
    var file = "";
    file = "C:\\proyecto\\factura.mrt";
    report.loadFile(file);

    // Create new DataSet object
    var dataSet = new Stimulsoft.System.Data.DataSet("Demo");
    // Load JSON data file from specified URL to the DataSet object
    dataSet.readJsonFile("C:\\proyecto\\factura.json");
    ...
    report.dictionary.synchronize();
               ...
               //RENDER
                report.renderAsync(function () {
                        ...
                        fs.writeFileSync("C:\\proyecto\\DocumentFail.pdf", buffer);
