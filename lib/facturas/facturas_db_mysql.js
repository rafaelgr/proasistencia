...
var crearPdfsFactura = function (dFecha, hFecha, clienteId, mantenedorId, comercialId, contratoId, empresaId, departamentoId, usuarioId,callback) {
    ...
    //CARGAR    
    var file = "";
    file = "C:\\Users\\Vicent\\Desktop\\proyecto\\factura.mrt";
    report.loadFile(file);

    // Create new DataSet object
    var dataSet = new Stimulsoft.System.Data.DataSet("Demo");
    // Load JSON data file from specified URL to the DataSet object
    dataSet.readJsonFile("C:\\Users\\Vicent\\Desktop\\proyecto\\factura.json");
    ...
    report.dictionary.synchronize();
               ...
               //RENDER
                report.renderAsync(function () {
                        ...
                        try {
                            fs.writeFileSync("C:\\Users\\Vicent\\Desktop\\proyecto\\DocumentFail.pdf", buffer);
