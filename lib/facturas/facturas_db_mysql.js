...
module.exports.putFacturaCabeceraDesdeParte = function (datos, callback) {
    var facturaId;
    var connection = getConnection();
    sql = "SELECT SUM(aCuentaCli) AS importeAnticipo, fac.totalConIva-SUM(par.aCuentaCli) AS restoPagar";
    sql += " FROM partes AS par";
...
module.exports.postCrearFactCliDesdeParte = function (seleccionados, deFecha, aFecha, fechaFactura, done) {
    ...
    sql += " (SUM(par.importe_cliente_iva)-SUM(par.aCuentaCli)) AS restoPagar,";
    ...
    sql += " (par.importe_cliente_iva-par.aCuentaCli) AS restoPagar,";
