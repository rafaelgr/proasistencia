            ...
            async.eachSeries(seleccionados, function (sel, callback2) {
                ...
                async.series([
                    ...
                    function(callback) {
                         ...
                         sql = " SELECT pt.descripcion AS descripcion, pt.unidades AS cantidad,ar.articuloId AS articuloId,pt.tipoIvaId, pt.iva AS porcentaje, ar.unidadId,";
...
module.exports.getFacturasUsuario = function (usuarioId, callback) {
    ...
    sql += " LEFT JOIN clientes as c ON c.clienteId = cm.clienteId";
    sql += " WHERE pf.contafich IS NULL AND pf.departamentoId IN (SELECT departamentoId FROM usuarios_departamentos WHERE usuarioId = ?)";
    sql += " ORDER BY pf.fecha";
