...
var fnGetNumeroFactura = function (factura, done) {
    ...
    con.query(sql, function (err, res) {
        ...
        con.query(sql, function (err, res) {
            ...
            factura.ano = ano;
            factura.serie = serie;
            fnComprobarOrdenCorrecto(factura.serie, factura.ano, factura.fecha, function (err, res) {
                if (err) return done(err);
                done(null, factura);
            }, con);
        })
...
module.exports.postCrearReport = function (dFecha, hFecha, clienteId, empresaId, tipoIvaId, conta, orden, callback) {
    ...
    var sql = "SELECT  f.empresaId,  emp.nombre AS empresaNombre, f.facturaId,  DATE_FORMAT(fecha,'%Y-%m-%d') AS fecha,";
