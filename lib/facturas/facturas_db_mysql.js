                        ...
                        function(callback) {
                            ...
                            con.query(sql, function (err, res) {
                                ...
                                async.eachSeries(res, function(r, done2) {
                                 var sql2 = "SELECT a.antClienId, a.totalConIva,o.referencia, a.contratoId, p.parteId, p.refPresupuesto";
                                 ...
                                 sql2 += " WHERE c.servicioId = ? AND p.parteId IN (?) AND o.referencia = c.referencia AND NOT a.antClienId IN (SELECT antCLienId from factura_antCliens)";
