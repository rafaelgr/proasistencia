...
router.get('/facpdf/:dFecha/:hFecha/:empresaId/:clienteId/:departamentoId', function (req, res) {
    var dFecha = req.params.dFecha;
    var hFecha = req.params.hFecha;
    var empresaId = req.params.empresaId;
    var clienteId = req.params.clienteId;
    ...
    facturasDb.getFacPdf(dFecha, hFecha, empresaId, clienteId, departamentoId, function (err, data) {
        if (err) return res.status(500).send(err.message);
        res.json("OK");
    });
});
