...
router.get('/correo/:dFecha/:hFecha/:clienteId/:mantenedorId/:comercialId/:contratoId', function (req, res) {
    var dFecha = req.params.dFecha;
    var hFecha = req.params.hFecha;
    ...
    var contratoId = req.params.contratoId;
    facturasDb.getPreCorreoFacturas(dFecha, hFecha, clienteId, mantenedorId, comercialId, contratoId, function (err, facturas) {
        if (err) return res.status(500).send(err.message);
        res.json(facturas);
    });
})
...
// PostEnviarCorreos
router.post('/preparar-correos/:dFecha/:hFecha/:clienteId/:mantenedorId/:comercialId/:contratoId', function (req, res) {
    var dFecha = req.params.dFecha;
    var hFecha = req.params.hFecha;
    var clienteId = req.params.clienteId;
    var mantenedorId = req.params.mantenedorId;
    var comercialId = req.params.comercialId;
    var contratoId = req.params.contratoId;
    facturasDb.postPrepararCorreos(dFecha, hFecha, clienteId, mantenedorId, comercialId, contratoId, function (err, result) {
        if (err) return res.status(500).send(err.message);
        res.json(result);
    });
});
