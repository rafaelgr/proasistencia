...
router.get('/correo/:dFecha/:hFecha/:clienteId/:mantenedorId', function (req, res) {
    var dFecha = req.params.dFecha;
    var hFecha = req.params.hFecha;
    var clienteId = req.params.clienteId;
    var mantenedorId = req.params.mantenedorId;
    facturasDb.getPreCorreoFacturas(dFecha, hFecha, clienteId, mantenedorId, function (err, facturas) {
        if (err) return res.status(500).send(err.message);
        res.json(facturas);
    });
})
...
// PostEnviarCorreos
router.post('/preparar-correos/:dFecha/:hFecha/:clienteId/:mantenedorId', function (req, res) {
    var dFecha = req.params.dFecha;
    var hFecha = req.params.hFecha;
    var clienteId = req.params.clienteId;
    var mantenedorId = req.params.mantenedorId;
    facturasDb.postPrepararCorreos(dFecha, hFecha, clienteId, mantenedorId, function (err, result) {
        if (err) return res.status(500).send(err.message);
        res.json(result);
    });
});
