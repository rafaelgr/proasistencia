...
router.get('/usuario/logado/departamento/:usuarioId/:departamentoId', function (req, res) {
    facturasDb.getFacturasUsuario(req.params.usuarioId, req.params.departamentoId, function (err, facturas) {
        if (err) {
            return res.status(500).send(err.message);
        } else {
            res.json(facturas);
...
router.get('/usuario/logado/departamento/all/:usuarioId/:departamentoId', function (req, res) {
    facturasDb.getFacturasAllUsuario(req.params.usuarioId, req.params.departamentoId, function (err, facturas) {
        if (err) {
            return res.status(500).send(err.message);
        } else {
            res.json(facturas);
