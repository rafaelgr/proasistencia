...
module.exports.getSeriesEmpresa = function(id, callback) {
    var connection = getConnection();
    sql = "SELECT"; 
    sql += " empresaSerieId, es.empresaId, dep.nombre AS departamentoNombre, tp.nombre AS tipoProyectoNombre,"
    sql += " es.serie_factura, es.serie_prefactura, emp.serieFacR, emp.seriePre";
