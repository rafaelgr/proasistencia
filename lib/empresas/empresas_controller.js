...
// getEmpresaCuenta
// devuelve un registro de la tabla empresas_cuentaspago 
router.get('/empresaCuentas/un/registro/:empresaCuentapagoId ', function(req, res) {
...
router.put('/empresaCuentas/:empresaCuentapagoId', function(req, res) {
