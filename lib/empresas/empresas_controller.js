...
router.post('/empresaCuentas/cuenta/pago/comprueba/existe/:conta', function(req, res) {
    empresasDb.getEmpresaCuentaConta(req.params.conta, req.body, function(err, cuenta) {
