    ...
    async.series([
        ...
        function (err, datos) {
            ...
            for (var i = 0; i < lineas.length; i++) {
                lineas[i].importe = numeral(lineas[i].importe).format('0,0.00 $');
                lineas[i].totalLinea = numeral(lineas[i].totalLinea).format('0,0.00 $');
                lineas[i].cantidad = numeral(lineas[i].cantidad).format('0,0.00');
            }
