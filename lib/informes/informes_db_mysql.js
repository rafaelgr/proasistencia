...
module.exports.getPrefactura = function (id, fcallback) {
    ...
    async.series([
        function (callback) {
            ...
            sql += " pf.total, pf.totalConIva, fp.nombre AS formaPago, pf.observaciones, pf.porcentajeRetencion, pf.importeRetencion";
        ...
        function (err, datos) {
            ...
            cabecera.porcentajeRetencion = numeral(cabecera.porcentajeRetencion).format('0,0.00');
            cabecera.importeRetencion = numeral(cabecera.importeRetencion).format('0,0.00 $');
...
module.exports.getFactura = function (id, fcallback) {
    ...
    async.series([
        function (callback) {
            ...
            sql += " pf.emisorNif, pf.emisorNombre, pf.emisorDireccion, pf.emisorCodPostal, pf.emisorPoblacion, pf.emisorProvincia,";
            sql += " pf.receptorNif, pf.receptorNombre, pf.receptorDireccion, pf.receptorCodPostal, pf.receptorPoblacion, pf.receptorProvincia,";
            sql += " pf.total, pf.totalConIva, fp.nombre AS formaPago, pf.observaciones, pf.periodo, pf.porcentajeRetencion, pf.importeRetencion,";
            ...
            sql += " cl.iban,";
            sql += " cnt.direccion as direccion2, cnt.codPostal as codPostal2, cnt.poblacion as poblacion2, cnt.provincia as provincia2";
...
module.exports.postSQL = function (sql, done) {
    var c = cm.getConnection();
    c.query(sql, function (err, data) {
        cm.closeConnection(c);
