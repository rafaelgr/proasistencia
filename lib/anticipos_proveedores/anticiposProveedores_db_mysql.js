...
module.exports.getAnticiposNoFacturablesUsuarioNueva = function (usuarioId, departamentoId, esColaborador, callback) {
    var connection = getConnection();
    var facturas = null;
    var sql = "";

    if (departamentoId == 0) {
        sql = recuperaSqlNoFacturablesAll(usuarioId, esColaborador);
    } else {
        sql = " SELECT";
        sql += " f.antproveServiciadoId,";
        sql += " cm.referencia,";
...
function recuperaSqlNoFacturablesAll(usuarioId, esColaborador) {
    var sql = "";
