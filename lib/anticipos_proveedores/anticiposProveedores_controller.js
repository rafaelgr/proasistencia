...
// Getanticipo
// devuelve las anticipos de un proveedor incompletos
router.get('/proveedor/anticipos/solapa/muestra/tabla/datos/anticipo/incompleto/completo/:proveedorId', function (req, res) {
    anticiposProveedoresDb.getAnticipoProveedorTodos(req.params.proveedorId, function (err, anticipo) {
        if (err) {
            return res.status(500).send(err.message);
        } else {
