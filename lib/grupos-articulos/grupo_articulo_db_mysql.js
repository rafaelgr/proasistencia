...
module.exports.postGrupoArticulo = function(grupoArticulo, callback) {
    ...
    connection.query(sql, function(err, result) {
        ...
        if (err) {
            ...
            //busca las cuentas contables de compras y ventas del grupo articulo y si no existe las crea
            //primero busca todas las empresas de la aplicacion y sus cuentas contables
            creaContasComprasVentas(grupoArticulo, callback);
...
module.exports.putGrupoArticulo = function(id, grupoArticulo, callback) {
    ...
    connection.query(sql, function(err, result) {
        ...
        if (err) {
            ...
            //busca las cuentas contables de compras y ventas del grupo articulo y si no existe las crea
            //primero busca todas las empresas de la aplicacion y sus cuentas contables
            comprobarComprasVentas(grupoArticulo, function (err, result) {
...
var comprobarComprasVentas = function(grupoArticulo, callback) {
    var connection = getConnection();
