...
module.exports.generarPdfYEnviar = async (propuesta) => {
  ...
  var file = process.env.REPORTS_DIR + "\\oferta_proyecta_nopresentacion.mrt";
  report.loadFile(file);

  // construimos la ruta absoluta hasta el xml
...
Stimulsoft.Base.Localization.StiLocalization.setLocalization(localizationData);
  ...
  let pos = 0;
    let sql = report.dataSources.list[pos].sqlCommand;
