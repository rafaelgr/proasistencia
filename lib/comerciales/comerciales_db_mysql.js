...
module.exports.getLimiteAnticipo = async (proveedorId, empresaServiciadaId, contratoId, comercialId, tipoComercialId) => {
    let conn = undefined
    var sql = "";
    var result = {};
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            if (tipoComercialId != 1) {
                ...
                sql += " LEFT JOIN contrato_comercial AS cc ON cc.comercialId = c.comercialId";
                sql += " LEFT JOIN contratos_comisionistas AS co ON co.comercialId = cc.comercialId";
                sql += " LEFT JOIN contratos AS con ON con.agenteId = c.comercialId ";
                sql += " WHERE c.comercialId = ? AND c.proveedorId = ? AND cc.empresaId = ? AND con.contratoId = ?";
                sql = mysql2.format(sql, [comercialId, proveedorId, empresaServiciadaId, contratoId])
            }
