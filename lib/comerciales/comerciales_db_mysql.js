    ...
    async.parallel(
        {
            ...
            contrato: function (callback) {
                buscarComisionConEmpresa(comercialId, empresaId, tipoMantenimientoId, function (err, res) {
                    if (err) callback(err);
                    callback(null, res);
                });
            },
...
var buscarComisionConEmpresa = function (comercialId, empresaId, tipoMantenimientoId, done) {
