...
router.get('/limite/anticipo/:proveedorId/:empresaServiciadaId/:contratoId/:comercialId/:tipoComercialId', async (req, res, next) => {
    try  {
        let result =  await comercialesDb.getLimiteAnticipo(req.params.proveedorId, req.params.empresaServiciadaId, req.params.contratoId,  req.params.comercialId, req.params.tipoComercialId);
        res.json(result);
    }catch(err) {
