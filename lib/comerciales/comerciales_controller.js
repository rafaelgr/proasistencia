...
router.get('/limite/anticipo/:proveedorId/:empresaServiciadaId/:contratoId', async (req, res, next) => {
    try  {
        let result =  await comercialesDb.getLimiteAnticipo(req.params.proveedorId, req.params.empresaServiciadaId, req.params.contratoId);
        res.json(result);
    }catch(err) {
