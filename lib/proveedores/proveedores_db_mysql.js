...
module.exports.getProveedor = function (id, callback) {
    ...
    sql += " tv.nombre AS tipoViaProfesional, ti.nombre AS tipoIvaProfesional, w.descripcion AS tipoRetencionProfesional, w.porcentajePorDefecto AS porcentajePordefectoRetencion, w.cuentaPorDefecto AS cuentaPorDefectoRetencion,";
