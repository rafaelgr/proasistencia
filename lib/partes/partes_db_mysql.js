...
module.exports.getParte = function(id, callback){
	var connection = getConnection();
    var partes = null;
	sql = "SELECT ac.*, ser.*, pro.nombre AS nombreproveedor, com.nombre as comercialNombre, cli.nombre AS cliNombre, cli.proId as proId, tp.nombre AS tipoProNom,";
	sql += " emp.nombre AS nomEmpre"
