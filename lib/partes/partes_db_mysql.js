...
module.exports.getPartesProveedor = function(proveedorId, abiertos, callback){
	var connection = getConnection();
	var partes = null;
	sql = "SELECT ac.*,  pro.nombre AS proveedorNombre, ser.nombreCliente,"; 
...
module.exports.getParte = function(id, callback){
	var connection = getConnection();
    var partes = null;
	sql = "SELECT ac.*, ser.numServicio, ser.horaEntrada, ser.fechaEntrada, ser.operadorAgente, ser.direccionTrabajo, ser.poblacionTrabajo, ser.urgente, ser.necesitaPresupuesto, ser.empresaId, pro.nombre AS nombreproveedor, com.nombre as comercialNombre, cli.nombre AS cliNombre, cli.proId as proId, tp.nombre AS tipoProNom,";
