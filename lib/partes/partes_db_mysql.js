...
// lee todos los registros de la tabla partes y
// los devuelve como una lista de objetos
module.exports.getPartesProveedor = function(proveedorId, abiertos, fecha, direccionTrabajo, callback){
	var connection = getConnection();
	var partes = null;
	sql = "SELECT ac.*,  pro.nombre AS proveedorNombre, ser.nombreCliente AS cliNombre, ser.direccionTrabajo, ser.poblacionTrabajo, cli.telefono1, cli.telefono2,"; 
	sql +="  estp.nombre AS estadoProfNombre,";
    sql += " emp.nombre as empresa, ser.horaEntrada, fp.nombre As formaPagoCliente,"; 
	...
	if(fecha != 'null') sql += " AND ac.fecha_solicitud LIKE '" + fecha + "%'";
