...
module.exports.postLineaParte = function (LineaParte, parteId,callback){
	var connection = getConnection();
	...
	connection.query(sql, function(err, result){
		...
		LineaParte.parteLineaId = result.insertId;
		callback(null, LineaParte);
	});
	closeConnectionCallback(connection, callback);
}
...
// putLineaParte
// Modifica el parte según los datos del objeto pasao
module.exports.putLineaParte = function(id, lineaParte, callback){
...
module.exports.deleteLineaParte = function(id, callback){
	var connection = getConnection();
