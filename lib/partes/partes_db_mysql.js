...
sql += " '" + dFecha + " 00:00:00' AS inicioIntervalo,";
sql += " '" + hFecha + " 00:00:00' AS finIntervalo,";
sql += " COALESCE(e.e.existenciasCostes, 0) AS existenciasCostes,";
...
sql += " LEFT JOIN clientes AS cli ON cli.clienteId = s.clienteId";
sql += " LEFT JOIN comerciales AS co ON co.comercialId = cli.comercialId";
sql += " WHERE p.fecha_cierre_profesional IS NULL";
sql += " AND p.fecha_cierre_cliente <  '" + dFecha + " 00:00:00'";
...
sql += " LEFT JOIN comerciales AS co ON co.comercialId = cli.comercialId";
sql += " WHERE p.fecha_cierre_profesional >=  '" + dFecha + " 00:00:00'";
sql += " AND p.fecha_cierre_profesional <=  '" + hFecha + " 00:00:00'";
sql += " AND p.fecha_cierre_cliente >=  '" + dFecha + " 00:00:00'";
sql += " AND p.fecha_cierre_cliente <=  '" + hFecha + " 00:00:00'";
...
sql += " LEFT JOIN comerciales AS co ON co.comercialId = cli.comercialId";
sql += " WHERE p.fecha_cierre_profesional <  '" + dFecha + " 00:00:00'";
sql += " AND (p.fecha_cierre_cliente IS NULL || p.fecha_cierre_cliente >  '" + hFecha + " 00:00:00')";
...
sql += " LEFT JOIN clientes AS cli ON cli.clienteId = s.clienteId";
sql += " LEFT JOIN comerciales AS co ON co.comercialId = cli.comercialId";
sql += " WHERE p.fecha_cierre_profesional >=  '" + dFecha + " 00:00:00' AND p.fecha_cierre_profesional <=  '" + hFecha + " 00:00:00'";
sql += " AND (p.fecha_cierre_cliente >  '" + hFecha + " 00:00:00' || p.fecha_cierre_cliente IS NULL)";
...
sql += " ";
sql += " WHERE NOT e.comercialId IS NULL ||";
sql += " NOT p.comercialId IS NULL ||";
sql += " NOT ppi.comercialId IS NULL ||";
sql += " NOT i.comercialId IS NULL ||";
sql += " NOT ei.comercialId IS NULL ||";
sql += " NOT ea.comercialId IS NULL ||";
...
module.exports.postCrearListadoPagosProfesionales = function (dFecha, hFecha, empresaId, callback) {
	...
	sql +=   dFecha + " AS inicioIntervalo,";
	sql +=   hFecha + " AS finIntervalo,";
    ...
    connection.query(sql, function (err, result) {
		...
		sql2 += " WHERE";
		if(empresaId > 0) {
			sql2 += " e.empresaId = " + empresaId;
		}
		sql2 += " AND (p.fecha_cierre_profesional >= '" + dFecha + " 00:00:00'";
		...
		sql2 += " AND p.fecha_cierre_profesional <= '" + hFecha + " 23:59:59'";
		sql2 += " AND p.fecha_cierre_cliente IS NULL) OR";
		sql2 += " ( p.fecha_cierre_profesional >= '" + dFecha + " 00:00:00'";
		sql2 += " AND p.fecha_cierre_profesional <= '" + hFecha + " 23:59:59'";
		sql2 += " AND p.fecha_cierre_cliente < '" + dFecha + " 00:00:00')";
...
var procesaResultadoPagoProfesionales = (datosPartes, datosFactura) => {
	...
	objPa.forEach( o => {
		...
		o.contado = parseFloat(o.actuacionesAbiertasContado + o.actuacionesAbiertasContado + o.pendientePagoContado);
