...
module.exports.getParte = function(id, callback){
	var connection = getConnection();
    var partes = null;
	sql = "SELECT ac.*, ser.horaEntrada, ser.fechaEntrada, ser.operadorAgente, ser.direccionTrabajo, ser.urgente, ser.necesitaPresupuesto, pro.nombre AS nombreproveedor, com.nombre as comercialNombre, cli.nombre AS cliNombre, cli.proId as proId, tp.nombre AS tipoProNom,";
