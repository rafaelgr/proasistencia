...
module.exports.getNuevaRefPresupuesto = function (facprove, callback) {
    fnGetNumeroRefParte(facprove, function (err, res) {
...
var fnGetNumeroRefParte = function(empresaId, ano, done) {
	...
	sql += " LEFT JOIN servicios AS ser ON ser.servicoId = par.servicioId"
