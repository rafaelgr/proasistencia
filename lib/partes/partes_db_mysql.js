...
module.exports.getPdfParte = (servicioId, parteId, callback) => {
	var connection = getConnection();
	crearObjJson(servicioId, parteId, function(err, obj) {
...
var crearObjJson = (servicioId, parteId, callback) => {
	...
	try{
		...
		sql +=" p.fecha_reparacion,";
		sql +=" p.observacionesDelProfesional,";
		sql +=" p.trabajos_realizados,";
		sql +=" p.trabajosPendientes,";
