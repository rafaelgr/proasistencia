...
module.exports.crearCorreosAEnviar = (datos, callback) => {
    ...
    var correo = {};
        ...
        var asunto = 'SERVICIO RECHAZADO'
        var texto = "El proveedor " + datos.proveedorNombre  + " ha rechazado la solicitud del servicio numero " + datos.numParte;
    
    
    correo = {
		emisor: datos.email,
		destinatario: "vicent@myariadna.com",
		asunto: asunto,
		cuerpo: texto
	}
