...
router.post('/facturas/reporte/actividad/crea/json/:dFecha/:hFecha/:clienteId/:empresaId', function (req, res) {
    var dFecha = req.params.dFecha;
    var hFecha = req.params.hFecha;
    var clienteId = req.params.clienteId;
    var empresaId = req.params.empresaId;
    partesDb.postCrearReportReporteActividad(dFecha, hFecha, clienteId, empresaId, function (err, result) {
