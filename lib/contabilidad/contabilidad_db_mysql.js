...
var contabilidadApi = {
    ...
    getFactPro: function (factura, numregis, done) {
        ...
        sql += " codigoRetencion AS codRet, cuentaRetencion AS cuenRet FROM facprove_retenciones";
        sql += " GROUP BY baseRetencion) AS fr ON fr.facProveId = f.facproveId";
    ...
    getModeloCobro: function (factura, done) {
        ...
        sql += " 0 AS numorden, fp.codigoContable AS codforpa, NULL AS fecvenci, 0 AS impvenci, NULL AS fecultco, NULL AS impcobro,";
