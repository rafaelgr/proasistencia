    ...
    getFactProLineas: function (factura, numregis, fianza, done) {
        ...
        con.query(sql, function (err, rows) {
            ...
            if(fianza > 0) {
                ...
                sql = "SELECT 1 AS numserie, ? AS numregis, f.fecha_recepcion AS fecharec, f.ano AS anofactu, 0 AS numlinea,"; 
                sql += "pro.cuentaContable AS codmacta, 100 AS baseimpo, 4 AS codigiva, 0 porciva, 0 AS porcrec,";
