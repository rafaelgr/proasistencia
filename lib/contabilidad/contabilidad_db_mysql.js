            ...
            if(f.antproveId) {
                contabilidadApi.comprobarCuentasCreadas(f, function (err, result) {
                    ...
                    if (result) {
                        ...
                        contabilidadApi.contabilizarUnaFacturaProveedorSoloLibro(f, function (err, contador) {
                            if (err) return callback(err);
                            if(contador == facturas.length) {
                                done(null, cuentas);
                            }
                ...
                contabilidadApi.comprobarCuentasCreadas(f, function (err, result) {
                    ...
                    if (result) {
                        ...
                        contabilidadApi.contabilizarUnaFacturaProveedor(f, contador,function (err, contador) {
                            if (err) return callback(err);
                            if(contador == facturas.length) {
                                done(null, cuentas);
                            }
