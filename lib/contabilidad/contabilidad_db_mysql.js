            ...
            if(f.antproveId) {
                contabilidadApi.comprobarCuentasCreadasCompras(f, function (err, result) {
                    ...
                    if (result) {
                        ...
                        contabilidadApi.contabilizarUnaFacturaProveedorSoloLibro(f,function (err, cont) {
                            if (err) return callback(err);
                ...
                contabilidadApi.comprobarCuentasCreadasCompras(f, function (err, result) {
                    ...
                    if (result) {
                        ...
                        contabilidadApi.contabilizarUnaFacturaProveedor(f, function (err, cont) {
                            if (err) return callback(err);
                            if(contador == facturas.length) {
                                done(null, cuentas);
                            }
