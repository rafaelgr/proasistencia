...
module.exports.getTarifaClienteLineas = function (id, callback) {
    ...
    sql = "SELECT CONCAT('( ',gr.nombre,' ) ',' [ ',COALESCE(a.codigoReparacion, ''),' ]',' -- ',a.nombre, ' -- ' , tf.precioUnitario,'€') AS unidadConstructiva, tf.*, a.codigoReparacion FROM tarifas_cliente_lineas AS tf";
