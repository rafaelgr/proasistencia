...
var obtainReportPdf = function () {
    ...
    var report = new Stimulsoft.Report.StiReport();
    verb = "GET";
    url = myconfig.apiUrl + "/api/usuarios/" + vm.susuarioId();
...
var rptFacturaParametros = function () {
    ...
    var url = myconfig.apiUrl + "/api/partes/listado/actuaciones/cerradas/por/usuario/crea/json/" + dFecha +"/" + hFecha +  "/" + usuarioId
