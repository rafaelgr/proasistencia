...
function initTablaContratosMantenedores() {
    tablaCarro = $('#dt_contratoMantenedor').dataTable({
        ...
        columns: [{
            ...
            render: function(data, type, row) {
                var bt1 = "<button class='btn btn-circle btn-danger' onclick='deleteContratoMantenedor(" + data + ");' title='Eliminar registro'> <i class='fa fa-trash-o fa-fw'></i> </button>";
                var bt2 = "<button class='btn btn-circle btn-success' onclick='editContratoMantenedor(" + data + ");' title='Editar registro'> <i class='fa fa-edit fa-fw'></i> </button>";
