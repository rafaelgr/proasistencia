...
var cargarOfertas = function (id) {
    var url = myconfig.apiUrl + "/api/ofertas/usuario/logado/departamento/beneficio/lineal/"+ usuario.usuarioId + "/" + vm.sdepartamentoId();
    if (id) {
...
var cargarOfertasNoAceptadas = function (id) {
    var url = myconfig.apiUrl + "/api/ofertas/no-aceptadas/usuario/logado/departamento/beneficio/lineal/"+ usuario.usuarioId + "/" + vm.sdepartamentoId();
    llamadaAjax("GET", url, null, function (err, data) {
        loadTablaOfertas(data);
    });
}
