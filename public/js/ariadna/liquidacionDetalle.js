...
var printGeneral = function () {
    var url = "infLiquidacionesDetalle.html?dFecha=" + spanishDbDate(vm.desdeFecha()) + "&hFecha=" + spanishDbDate(vm.hastaFecha()) + "&comercialId=" + vm.comercialId() + "&tipoColaborador=1";
    window.open(url, '_new');
}