/*-------------------------------------------------------------------------- 
contratoImpagoGeneral.js
Funciones js par la página ContratoImpagoGeneral.html
...
function initForm() {
    ...
    initTablaContratos();
    //
    var f = getCookie('filtro_contratos_impago');
    if (f != undefined) {
...
var limpiarFiltros = function () {
    var returnUrl = "ContratoImpagoGeneral.html?cleaned=true"
    deleteCookie('filtro_contratos_impago');
...
function cargarContratos() {
    var mf = function (id, filtros) {
        ...
        let url = myconfig.apiUrl + "/api/contratos/todos/usuario/departamento/impagos/" + dFecha + "/" + hFecha + "/" + empid + "/" + usuario.usuarioId + "/" + vm.sdepartamentoId();
        if (id) {
            var data = {
                id: contratoId
            }
