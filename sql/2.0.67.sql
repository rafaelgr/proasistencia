...
(5, 10, 'Prof. tarifa 6'), (6, 10, 'Clientes tarifa 1');
...
<<<<<<< HEAD
DROP TABLE tarifa_temp;
CREATE TABLE tarifa_temp AS (SELECT 6 AS tarifaId, articuloId, 0 AS precioUnitario FROM tarifas_lineas
...
>>>>>>> a8d95cf1968557af9dcff6d9cf91538723900ac8
