...
ALTER TABLE `contratos`   
  ...
  ALTER TABLE `contrato_planificacion_temporal`   
	ADD COLUMN `esAdicional` TINYINT(1) DEFAULT 0 NULL AFTER `formaPagoId`;

ALTER TABLE `contrato_planificacion_temporal`   
	ADD COLUMN `contratoAdicionalId` INT(11) NULL AFTER `esAdicional`;

  ALTER TABLE `contrato_planificacion_temporal`   
	ADD COLUMN `refPresupuestoAdicional` VARCHAR(211) NULL AFTER `contratoAdicionalId`;

  ALTER TABLE `proasistencia`.`contrato_planificacion_temporal`   
	ADD COLUMN `importeIntereses` DECIMAL(12,2) NULL AFTER `refPresupuestoAdicional`;
