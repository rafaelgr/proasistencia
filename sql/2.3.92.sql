...
CREATE TABLE `liquidacion_comercial_obras` (
  ...
  `30pagadoAnterior` decimal(12,2) default NULL,
  `30pagadoPeriodo` decimal(12,2) default NULL,
  `20pagadoAnterior` decimal(12,2) default NULL,
  `20pagadoPeriodo` decimal(12,2) default NULL,
  `50pagadoAnterior` decimal(12,2) default NULL,
  `50pagadoPeriodo` decimal(12,2) default NULL,
