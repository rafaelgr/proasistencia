...
ALTER TABLE `profesiones_departamentos` ADD CONSTRAINT `profesionesDepartamentosDepartamentoFK` FOREIGN KEY (`departamentoId`) 
REFERENCES `departamentos`(`departamentoId`) ON UPDATE CASCADE ON DELETE CASCADE;
